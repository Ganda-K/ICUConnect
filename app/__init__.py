...
def create_app():
    ...
    app.config.from_mapping(
        SECRET_KEY='dev',
        SQLALCHEMY_DATABASE_URI='postgresql://final_icu_user:W0jPXLgAskOFhwXXDALBqj1nzY03peKi@dpg-d1s1s5mmcj7s73a0tm30-a.oregon-postgres.render.com/final_icu',
    ...
    app.config.update(
        ...
        MAIL_PORT=587,
        MAIL_USE_TLS=True,
        MAIL_USERNAME='kateamimo@gmail.com',    
        MAIL_PASSWORD=os.environ.get('MAIL_PASSWORD'),
        MAIL_DEFAULT_SENDER='kateamimo@gmail.com',
    )
